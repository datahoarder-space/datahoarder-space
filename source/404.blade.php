...
<div class="flex flex-col items-center mt-32 text-textcolor">
    ...
    <p class="text-xl">
        Sorry about that. If you continue to have this issue, please let us know in the <a href="https://discord.gg/NG2G7qe">Discord server</a> so we can get it sorted.
    </p>
</div>
@endsection
